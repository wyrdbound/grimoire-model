...
from wyrdbound_model.core.registry import ModelRegistry, register_model, get_default_registry
from wyrdbound_model import ModelDefinition, create_model
...
class TestRegistryLogging:
    ...
    def test_model_registration_conflict_warning(self):
        ...
        model_def1 = ModelDefinition(
            id="test_model",
            name="First Model",
            attributes={"field1": {"type": "str"}}
        )
        
        model_def2 = ModelDefinition(
            id="test_model", 
            name="Second Model",
            attributes={"field2": {"type": "int"}}
        )
        ...
        assert "Model 'test__test_model' already registered. Overwriting with new definition." in log_output
...
class TestGlobalRegistryLogging:
    ...
    def test_global_register_model_logging(self):
        ...
        log_output = self.get_log_output()
        assert "Model 'global__global_test' already registered. Overwriting with new definition." in log_output
...
class TestLoggerConfiguration:
    ...
    def test_null_handler_default(self):
        ...
        fresh_logger = logging.getLogger('wyrdbound_model.fresh.test')
        ...
        assert has_null_handler or len(handlers) == 0  # Either explicit null handler or no handlers
...
class TestLoggingInheritanceResolution:
    ...
    def test_inheritance_resolution_logging(self):
        ...
        base_def = ModelDefinition(
            id="base",
            name="Base Model",
            attributes={"base_field": {"type": "str"}}
        )
        ...
        try:
            resolved = resolve_model_inheritance(child_def, registry)
...
class TestLoggingIntegration:
    ...
    def test_end_to_end_logging_scenario(self):
        ...
        try:
            ...
            model1 = create_model(model_def1, {"field": "test"})
            model2 = create_model(model_def2, {"field": 42})
